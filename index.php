...
<main id="main">
    <section class="hero section" id="top">
        <div class="container hero-grid">
            ...
            <div class="hero-panel reveal form-panel" aria-label="Форма заявки на ремонт">
                <form class="lead-form hero-lead-form" data-lead-form novalidate>
                    ...
                    <label class="consent"><input type="checkbox" name="consent_data" value="1" required><span>Даю согласие на обработку персональных данных для обработки моей заявки и обратной связи.</span></label>
                    <label class="consent"><input type="checkbox" name="consent_policy" value="1" required><span>Подтверждаю, что ознакомлен(а) с <a href="privacy.html" target="_blank" rel="noopener">Политикой обработки персональных данных</a>.</span></label>
